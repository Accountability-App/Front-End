...
/* harmony import */ var _buddies_modal_buddies_modal_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../buddies-modal/buddies-modal.component */ "Puef");
...
/* harmony import */ var _http_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./http.service */ "Mv2f");
...
let Tab2Page = class Tab2Page {
    constructor(popoverController, modalController, _http, router) {
        this.popoverController = popoverController;
    ...
    presentPopover(event) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const popover = yield this.popoverController.create({
                component: _buddies_popover_buddies_popover_component__WEBPACK_IMPORTED_MODULE_7__["BuddiesPopoverComponent"]
            });
    ...
    presentModal(event) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const modal = yield this.modalController.create({
                component: _buddies_modal_buddies_modal_component__WEBPACK_IMPORTED_MODULE_6__["BuddiesModalComponent"]
            });
...
let BuddiesModalComponent = class BuddiesModalComponent {
    constructor(modalController, _http, router) {
        this.modalController = modalController;
        this._http = _http;
        this.router = router;
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-content>\n  <ion-searchbar id=\"username-search\" placeholder=\"Username\"></ion-searchbar>\n  <ion-button expand=\"block\" (click)=\"search()\">Search</ion-button>\n</ion-content>");
